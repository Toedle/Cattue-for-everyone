...
$wp_customize->add_panel(
	...
	$wp_customize->add_section(
		...
		$wp_customize->add_setting(
			'wp_store_innerpage_setting_single_post_feat_img',
			array(
				'default' =>  '1',
				'sanitize_callback'     =>  'wp_store_sanitize_checkbox'
				)
		...
		$wp_customize->add_control(
			new Wp_store_WP_Customize_Switch_Control(
				$wp_customize,
				'wp_store_innerpage_setting_single_post_feat_img',array(
					'section'       =>      'wp_store_innerpage_setting_single_post',
					'label'         =>      __('Enable Featured Image', 'wp-store'),
					'description'         =>      __('Show Featured Image on Single Post.', 'wp-store'),
					'type'          =>      'switch',
					'output'        =>      array('Yes', 'No')
					)
				)
